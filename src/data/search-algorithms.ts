import type { SearchAlgorithms } from './types';

export const searchAlgorithms: SearchAlgorithms = {
  array: [
    {
      name: 'Linear',
...
// Legend for graph algorithm variables
export const searchAlgorithmLegend = [
  { symbol: 'v', meaning: 'Number of vertices' },
  { symbol: 'e', meaning: 'Number of edges' },
  { symbol: 'b', meaning: 'Branching factor' },
  { symbol: 'd', meaning: 'Depth of optimal solution' },
];
