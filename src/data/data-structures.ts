...
export const dataStructures: DataStructure[] = [
  ...
  },
  {
    ...
    time: {
      average: { access: 'N/A', search: 'Θ(log(n))', insertion: 'Θ(log(n))', deletion: 'Θ(log(n))' },
      worst: { access: 'N/A', search: 'O(n)', insertion: 'O(n)', deletion: 'O(n)' },
    },
    space: { worst: 'O(n)' },
  },
  {
  ...
  },
  {
    ...
    time: {
      average: { access: 'N/A', search: 'Θ(log(n))', insertion: 'Θ(log(n))', deletion: 'Θ(log(n))' },
      worst: { access: 'N/A', search: 'O(log(n))', insertion: 'O(log(n))', deletion: 'O(log(n))' },
    },
    space: { worst: 'O(n)' },
  },
  {
  ...
  },
  {
    ...
    time: {
      average: { access: 'Θ(1)', search: 'Θ(n)', insertion: 'Θ(log(n))', deletion: 'Θ(log(n))' },
      worst: { access: 'O(1)', search: 'O(n)', insertion: 'O(log(n))', deletion: 'O(log(n))' },
    },
    space: { worst: 'O(n)' },
  },
  {
  ...
  },
  {
    ...
    time: {
      average: { access: 'N/A', search: 'Θ(1)', insertion: 'Θ(1)', deletion: 'Θ(1)' },
      worst: { access: 'N/A', search: 'O(n)', insertion: 'O(n)', deletion: 'O(n)' },
    },
    space: { worst: 'O(n)' },
  },
  {
    ...
    time: {
      average: { access: 'Θ(1)', search: 'Θ(V + E)', insertion: 'Θ(1)', deletion: 'Θ(1)' },
      worst: { access: 'O(1)', search: 'O(V + E)', insertion: 'O(1)', deletion: 'O(1)' },
    },
    space: { worst: 'O(V + E)' },
  },
];
...
export const dataStructureGroups = [...new Set(dataStructures.map((ds) => ds.group))];
